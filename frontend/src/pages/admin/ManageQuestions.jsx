...
const ManageQuestions = () => {
  ...
  <button className="add-button cursor-pointer bg-blue-500 hover:bg-blue-600 active:bg-blue-700 text-white py-2 px-8 md:px-16 lg:px-20 rounded-full mb-4">
     Add Question
  </button>
</div>
  ...
  <>
    ...
    <input
      ...
      onChange={(e) =>
        setEditedData({ ...editedData, questionImage: e.target.value })
      }
